...
voice = PiperVoice.load("/Users/lukeofthehill/repos/silly-things/richter_radio/TTS_tests/en_GB-northern_english_male-medium.onnx")
syn_config=SynthesisConfig(
    ...
    # noise_scale=0.02,      # Introduces some tonal variation (intonation)
     noise_w_scale=0.2,      # Adds variation in pronunciation and rhythm
...
with wave.open("test.wav", "wb") as wav_file:
    voice.synthesize_wav(
                          "You're listening to Richter Radio. I'm your host, DJ Trace."
                         , wav_file
...
subprocess.run([
    ...
    "-codec:a", "libmp3lame",
    "-qscale:a", "2",
    "/Users/lukeofthehill/repos/silly-things/richter_radio/TTS_tests/dj_trace.mp3"
])
